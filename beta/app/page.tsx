  ...
  return (
    <section className="content list-page">
      <div className="list-notes-controls">
        ...
        <button className="notes-view-tab" onClick={onNotes}><NotebookPen /> ANTECKNINGAR</button>
      </div>
