...
function BudgetTransferEditor({settings,monthKey,account,onClose,onSave}:{settings:BudgetSettings;monthKey:string;account:Account;onClose:()=>void;onSave:(entry:BudgetEntry)=>Promise<void>}){
