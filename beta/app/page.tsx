...
function AuthenticatedApp() {
  ...
  return (
    <main className={`app-shell theme-${activeTheme.id}`} style={themeStyle}>
      ...
      {page === "recipe-discover" && <DiscoverRecipesPage recipes={publicRecipes} lists={visibleLists} onAddToList={addRecipeToList}/>}
