...
const budgetOccurrencePaid=(entry:BudgetEntry,occurrenceDate:string,today=calendarDateKey(new Date()))=>entry.status!=="planned"||(entry.autoPay===true&&occurrenceDate<=today);
