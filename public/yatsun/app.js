...
function updateMatchPlayers(multiplayer,room=null){
  ...
  $$('.score-section-block>strong').forEach(label=>label.dataset.opponent=(multiplayer?(room.otherName||'Vän'):cards[1].querySelector('strong').textContent).split(' ')[0]);
