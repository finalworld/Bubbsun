...
type Sale = { id: number; time: string; payment: "Swish" | "Kontant"; lines: SaleLine[]; kind?: "sale" | "refund"; reason?: string; cashier?: string; sessionId?: string };
...
export default function Home() {
  ...
  const [refundPayment, setRefundPayment] = useState<"Swish" | "Kontant" | null>("Kontant");
  ...
  function reopenPreviousSale() {
    ...
    setPayment(previousSale.payment);
