...
export type BudgetSettings = { banks: BudgetBank[]; defaultAccountId?: string; categoryBudgets?: Record<string,number>; monthlyCategoryBudgets?: Record<string,Record<string,number>>; savingsGoals?: BudgetSavingsGoal[]; updatedAt: number };
